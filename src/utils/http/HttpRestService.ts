...
export class HttpRestService {
  ...
  private apiTmp: string = "";
  private actionTmp: HttpActionEnum = HttpActionEnum.GET;
  private bodyTmp: any = null;
  ...
  public async relaunch() {
    return this.send(this.apiTmp, this.actionTmp, this.bodyTmp);
  }
